...
public class DateUtil {
	 ...
	 *
	 * @param dateStr 待解析的时间串
	 * @param format  时间串解析的格式
	 * @return
	 */
	...
	public static String nextDate(String format) {
		...
		return getTodayByFormat(date, format);
	}

	// 获取当前日期的下一个工作日
	public static String nextWorkDate() {
	 ...
	 * 比较两个日期的大小--通用法
	 */
	public static String compareCommonDate(String start, String end) {
		String flag = "";
		try {
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			Date date1 = sdf.parse(start);
...
//	        System.out.println("天数差："+days);
	...
	public static String getSpecifiedDayBefore() {
		...
		date = calendar.getTime();
		String date1 = DateUtil.getTodayByFormat(date, "yyyy-MM-dd");
		return date1;
	}
	 ...
	 * @params [str]
	 * @describe 判断日期字符串是否符合规则
	 * @date 2017/10/19 下午8:18
	 **/
    ...
    //返回两个日期之间的每一天
	public static ArrayList<String> getDate(String start, String end) throws Exception {
//		 start = new SimpleDateFormat("yyy-MM-dd").parse("2008-08-29");
//		 end = new SimpleDateFormat("yyy-MM-dd").parse("2008-09-02");
		Date start1 = stringToDate(start, "yyyy-MM-dd");
		Date end1 = stringToDate(end, "yyyy-MM-dd");
//        start = new Date(start.getTime() + 86400000);
		ArrayList<String> array = new ArrayList<>();
		while (start1.getTime() <= end1.getTime()) {
			array.add(new SimpleDateFormat("yyyy-MM-dd").format(start1)+",");
			start1 = new Date(start1.getTime() + 86400000);
		}
